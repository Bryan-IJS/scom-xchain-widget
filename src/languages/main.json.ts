export default {
  "en": {
    ...
    "approving": "Approving",
    "max" : "Max",
    "xchain_dapp_supports_this_network_please_switch_network_in_the_connected_wallet":
    "Xchain dapp supports this network {{chainName}} ({{chainId}}), please switch network in the connected wallet.",
  ...
  "vi": {
    ...
    "max": "Tối đa",
    "xchain_dapp_supports_this_network_please_switch_network_in_the_connected_wallet": 
      "Xchain dapp hỗ trợ mạng lưới {{chainName}} ({{chainId}}), vui lòng chuyển mạng trong ví đã kết nối.",
    ...
    "base_fee": "Phí Cơ bản",
    "this_fee_is_paid_to_the_trolls_to_cover_gas_fee_on_the_target_chain": 
      "Phí này được trả cho các trolls để trang trải phí gas trên Chuỗi Đích.",
    "imbalance_fee": "Phí Mất Cân bằng",
    "this_fee_is_acted_as_an_incentive_to_balance_the_vault": 
      "Phí này hoạt động như một động lực để cân bằng kho tiền.",
    ...
    "this_fee_is_paid_to_the_bridge_vault_liquidity_provider_on_target_chain": 
      "Phí này được trả cho Nhà cung cấp Thanh khoản Kho Vault Cầu Nối trên Chuỗi Đích.",
    "protocol_fee": "Phí Giao thức",
    "this_fee_is_paid_to_the_troll_owners_on_the_cross_chain_network": 
      "Phí này được trả cho chủ sở hữu trolls trên Mạng Lưới Chuỗi Chéo.",
